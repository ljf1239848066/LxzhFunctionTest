...
package com.lxzh123.funcdemo.record1;
...
public class SoundRecorderActivity extends Activity
    ...
    static final int BITRATE_AAC = 22050;
    ...
    public void onCreate(Bundle icycle) {
        ...
        if (i != null) {
            String s = i.getType();
            if (AUDIO_AMR.equals(s) || AUDIO_3GPP.equals(s)||AUDIO_AAC.equals(s) || AUDIO_ANY.equals(s)
                    || ANY_ANY.equals(s)) {
                mRequestedType = s;
            } else if (s != null) {
        ...
        setContentView(R.layout.layout_record1);
            ...
            case R.id.recordButton:
                ...
                if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                    ...
                    if (AUDIO_AMR.equals(mRequestedType)) {
                        ...
                        mRecorder.startRecording(MediaRecorder.OutputFormat.AAC_ADTS,".aac",this);
                    } else {
    ...
    private void updateUi() {
        ...
        switch (mRecorder.state()) {
            ...
            case Recorder.RECORDING_STATE: 
                ...
                mStateLED.setImageResource(R.drawable.record1_recording_led);
                mStateMessage2.setVisibility(View.VISIBLE);
