...
import com.lxzh123.funcdemo.util.tools.HttpUtil;
...
public class GetWeather {
    private final static String TAG="GetWeather";
    ...
    private String getSinaUrl(String city, String day){
        String citycode;
        try{
            citycode=java.net.URLEncoder.encode(city, "gb2312");
        }catch (UnsupportedEncodingException ex){
            citycode="101010100";//Beijing
        }
        return SINA_URL + "?city="+ citycode + "&password="+ PASSWORD + "&day=" + day;
    }

    private String[] cityCodes=new String[]{"101010100","北京",
            "101010200","海淀",
            "101010300","朝阳",
            "101010400","顺义",
            "101010500","怀柔",
    ...
    private String getWeacherComUrl(String city){
        int len=cityCodes.length;
        String citycode="101010100";
        for(int i=1;i<len;i+=2){
            if(city==cityCodes[i]){
                citycode=cityCodes[i-1];
                break;
            }
        }
        String baseUrl="http://www.weather.com.cn/data/sk/$citycode.html";
        String url=baseUrl.replace("$citycode",citycode);
        return url;
    }
     ...
     */ 
    public void UpdateSinaWeatherInfo(String city, String day) {
        if (city.equals("")) { 
            isLoaded = false; 
            return; 
        } 
        String html = null; 
        try {
            String url=getSinaUrl(city,day);
            Log.i(TAG,url);
//            html = doGet(url);
            OkHttpClient client=new OkHttpClient();
            html=HttpUtil.SyncRequestGet(client,url);
            Log.i(TAG,html);
            ...
            StringBuffer weaInfo=new StringBuffer();
            weaInfo.append(city+" 的天气为\n");
            weaInfo.append("白天天气:"+status1+"\n");
            weaInfo.append("夜晚天气:"+status2+"\n");
            weaInfo.append("白天天气 拼音:"+figure1+"\n");
            weaInfo.append("夜晚天气 拼音:"+figure2+"\n");
            weaInfo.append("白天风向:"+direction1+"\n");
            weaInfo.append("夜晚风向:"+direction2+"\n");
            weaInfo.append("白天风级:"+power1+"\n");
            weaInfo.append("夜晚风级:"+status2+"\n");
            weaInfo.append("白天温度:"+temperature1+"\n");
            weaInfo.append("夜晚温度:"+temperature2+"\n");
            weaInfo.append("体感温度:"+tgd+"\n");
            weaInfo.append("紫外线指数:"+zwx_l+"\n");
            weaInfo.append("紫外线说明:"+zwx_s+"\n");
            weaInfo.append("体感度指数:"+ssd_l+"\n");
            weaInfo.append("体感度说明:"+ssd_s+"\n");
            weaInfo.append("空调指数:"+ktk_l+"\n");
            weaInfo.append("空调说明:"+ktk_s+"\n");
            weaInfo.append("洗车指数:"+xcz_l+"\n");
            weaInfo.append("洗车说明:"+xcz_s+"\n");
            weaInfo.append("穿衣指数:"+chy_l+"\n");
            weaInfo.append("穿衣说明:"+chy_s+"\n");
            weaInfo.append("污染物扩散条件:"+pollution_l+"\n");
            weaInfo.append("污染物扩散条件说明:"+pollution_s+"\n");
            weaInfo.append("感冒指数:"+gm_l+"\n");
            weaInfo.append("感冒说明:"+gm_s+"\n");
            weaInfo.append("运动指数:"+yd_l+"\n");
            weaInfo.append("运动说明:"+yd_s+"\n");
            weatherInfo= weaInfo.toString();
            isLoaded = true;
        } catch (Exception e) {
            isLoaded = false; 
        } 
    ...
    public void UpdateWeatherInfo(String city) {
        ...
        String html = null;
        try {
            String url=getWeacherComUrl(city);
            Log.i(TAG,url);
            OkHttpClient client=new OkHttpClient();
            html=HttpUtil.SyncRequestGet(client,url);
            Log.i(TAG,html);
            ...
            WeatherModel weatherMdl=JSON.parseObject(html,WeatherModel.class);

            if(weatherMdl==null||weatherMdl.getWeatherinfo()==null){
                weatherInfo="";
                isLoaded=false;
                return;
            }

            Weather weather=weatherMdl.getWeatherinfo();
            this.city = weather.getCity();

            StringBuffer weaInfo=new StringBuffer();
            weaInfo.append(city+" 的天气为\n");
            weaInfo.append("温度:"+weather.getTemp()+"\n");
            weaInfo.append("风向:"+weather.getWD()+"\n");
            weaInfo.append("风力:"+weather.getWS()+"\n");
            weaInfo.append("湿度:"+weather.getSD()+"\n");
            weaInfo.append("WSE:"+weather.getWSE()+"\n");
            weaInfo.append("Time:"+weather.getTime()+"\n");
            weaInfo.append("isRadar:"+weather.getIsRadar()+"\n");
            weaInfo.append("Radar:"+weather.getRadar()+"\n");
            weaInfo.append("njd:"+weather.getNjd()+"\n");
            weaInfo.append("qy:"+weather.getQy()+"\n");
            weaInfo.append("rain:"+weather.getRain()+"\n");
            weatherInfo= weaInfo.toString();
