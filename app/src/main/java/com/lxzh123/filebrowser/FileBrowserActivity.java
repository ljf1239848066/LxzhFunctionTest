package com.lxzh123.filebrowser;
...
public class FileBrowserActivity extends ListActivity {
	...
	private void initFileList() {
		Log.d("FileBrowser", android.os.Environment.getExternalStorageDirectory()+"/NotePad/");
		File path = new File(
				android.os.Environment.getExternalStorageDirectory() + "/NotePad/");
